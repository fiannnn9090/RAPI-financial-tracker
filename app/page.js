...
const NAV_TABS = [['beranda', '🏠'], ['transaksi', '💸'], ['analisis', '📊'], ['target', '🎯'], ['profil', '👤']];
...
function Dashboard({ user, data, setData, autoGenerated = 0, fontScale = '1', onChangeFontScale, onChangeLang, lang = 'id', theme = 'system', onChangeTheme }) {
  ...
  return <main className="dashboard-page">
    <div className="dashboard app-frame" id="dashboard">
      ...
      {health.now.score != null && <ScoreCard health={health} onOpen={() => { setTab('analisis'); }} />}
      {adviceHigh[0] && <button type="button" className="advice-teaser clay-card brutal-card" aria-label={t('adv.seeAll')} onClick={() => { setTab('analisis'); }}>
