/* i18n sederhana: kamus flat, pasangan id/en berdampingan.
   ...
   - Libs murni (recap/pdf/reminders/profileCard) memakai t() juga karena
     dipanggil lewat event/effect SETELAH render — bahasa sudah sinkron. */
...
export function t(key, vars) {
  ...
  const text = entry ? entry[ACTIVE_LANG] : null;
