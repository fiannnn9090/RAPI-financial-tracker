...
const DICT = {
  ...
  "act.tx": { id: "Catat Transaksi", en: "Log Transaction" },
  "act.budget": { id: "Atur Budget", en: "Set Budget" },
  "act.recurring": { id: "Tambah Rutin", en: "Add Recurring" },
  "act.debt": { id: "Hutang & Piutang", en: "Debts & Loans" },
  "act.goal": { id: "Tambah Target", en: "Add Goal" },
  ...
  /* IA-A: heading ringkas — pertanyaan & subline dihapus dari Beranda */
  ...
  "recap.teaserTitle": { id: "Tap untuk lihat rekap serumu", en: "Tap to see your recap" },
  ...
  "sim.projYearTitle": { id: "Proyeksi Saldo", en: "Projected Balance" },
  "sim.projYearPeriod": { id: "1 Tahun", en: "1 Year" },
  ...
  "tx.recentTitle": { id: "Transaksi Terakhir", en: "Recent Transactions" },
  "tx.segShort": { id: "Transaksi", en: "Transactions" },
  "tx.viewAll": { id: "Lihat Semua", en: "See All" },
  "tx.seeAll": { id: "Lihat Semua Histori", en: "View Full History" },
  "tx.emptyHint": { id: "Belum ada transaksi", en: "No transactions yet" },
  ...
  "day.today": { id: "Hari Ini", en: "Today" },
  "day.yesterday": { id: "Kemarin", en: "Yesterday" },
  "day.ago": { id: "{n} Hari Lalu", en: "{n} days ago" },
  "tx.detailKicker": { id: "DETAIL TRANSAKSI", en: "TRANSACTION DETAIL" },
  "tx.statusSuccess": { id: "Berhasil", en: "Success" },
  "tx.detailTime": { id: "Waktu", en: "Time" },
  "tx.detailSource": { id: "Sumber Dana", en: "Source" },
  "tx.xpTitle": { id: "Mantap!", en: "Nice!" },
  "tx.xpBody": { id: "Kamu mendapat EXP.", en: "You earned EXP." },
  "tx.share": { id: "Bagikan Resi", en: "Share Receipt" },
  "tx.edit": { id: "Edit Transaksi", en: "Edit Transaction" },
  "tx.delete": { id: "Hapus transaksi", en: "Delete transaction" },
  "tx.receiptCopied": { id: "Resi tersalin ke clipboard", en: "Receipt copied to clipboard" },
  ...
  "label.wallet": { id: "Sumber Dana", en: "Source" },
  "form.tx.kickerEdit": { id: "EDIT TRANSAKSI", en: "EDIT TRANSACTION" },
  "form.tx.titleEdit": { id: "Perbarui detail transaksi", en: "Update transaction details" },
  "form.tx.phNote": { id: "Tambahkan catatan...", en: "Add a note..." },
  "btn.saveChanges": { id: "Simpan Perubahan", en: "Save Changes" },
  ...
  "acct.nameSave": { id: "Ganti username", en: "Change username" },
  "acct.same": { id: "Username sama dengan yang sekarang.", en: "Same as your current username." },
  "acct.nameDone": { id: "Username diganti.", en: "Username updated." },
  "acct.newPass": { id: "Kata sandi baru (min. 6 karakter)", en: "New password (min. 6 characters)" },
  "acct.again": { id: "Ulangi kata sandi baru", en: "Repeat new password" },
  "acct.passSave": { id: "Ganti kata sandi", en: "Change password" },
  "acct.mismatch": { id: "Konfirmasi tidak sama dengan kata sandi baru.", en: "Confirmation doesn't match the new password." },
  "acct.passDone": { id: "Kata sandi diganti.", en: "Password updated." },
  "acct.fail": { id: "Gagal menyimpan: {msg}", en: "Could not save: {msg}" },
  ...
  /* DP2 — tab Analisis */
  "an.title": { id: "Analisis keuangan", en: "Money analysis" },
  "an.sub": { id: "Skor, saran, rekomendasi & simulasi — semua dari data kamu sendiri.", en: "Score, advice, recommendations & simulation — all from your own data." },
  ...
  "adv.detail": { id: "Lihat Detail", en: "View Details" },
  "adv.close": { id: "Tutup", en: "Close" },
  ...
  "adv.score.lev.good": { id: "Baik", en: "Good" },
  "adv.score.lev.mid": { id: "Sedang", en: "Fair" },
  "adv.score.lev.low": { id: "Perlu perhatian", en: "Needs attention" },
  ...
  /* Kartu breakdown prototype (remap proxy ke 5 dimensi prototype) */
  "adv.score.card.savings": { id: "Nabung", en: "Nabung" },
  "adv.score.card.recurring": { id: "Hutang", en: "Debt" },
  "adv.score.card.buffer": { id: "Darurat", en: "Emergency" },
  "adv.score.card.momentum": { id: "Investasi", en: "Investing" },
  "adv.score.card.budget": { id: "Pengeluaran Wajib", en: "Mandatory Spending" },
  /* Kata status prototype per kartu */
  "adv.score.stat.savings": { id: "Good", en: "Good" },
  "adv.score.stat.recurring": { id: "Warning", en: "Warning" },
  "adv.score.stat.buffer": { id: "Aman", en: "Safe" },
  "adv.score.stat.momentum": { id: "On Track", en: "On Track" },
  "adv.score.stat.budget": { id: "Sesuai Budget", en: "On Budget" },
  ...
  "recM.segShort": { id: "Rutin", en: "Recurring" },
  ...
  "danger.zoneLabel": { id: "Zona Berbahaya", en: "Danger Zone" },
  ...
  "prof.menu.akun": { id: "Ganti username & password", en: "Change username & password" },
  ...
  /* F8 — hutang & piutang */
  "common.yesContinue": { id: "Ya, lanjut", en: "Yes, continue" },
  "debts.title": { id: "Hutang & Piutang", en: "Debts & Loans" },
  "debts.kicker": { id: "CATAT HUTANG", en: "TRACK A DEBT" },
  "debts.add": { id: "+ Catat", en: "+ Add" },
  "debts.addTitle": { id: "Catat hutang / piutang", en: "Track a debt" },
  "debts.editTitle": { id: "Edit catatan", en: "Edit record" },
  "debts.offNote": { id: "Fitur hutang & piutang belum aktif untuk akun ini.", en: "Debt tracking isn't active for this account yet." },
  "debts.netWorth": { id: "Kekayaan Bersih", en: "Net worth" },
  "debts.openAria": { id: "Buka halaman hutang & piutang", en: "Open debts & loans" },
  "debts.filterAll": { id: "Semua", en: "All" },
  "debts.filterAria": { id: "Filter arah hutang piutang", en: "Filter by direction" },
  "debts.dir.receivable": { id: "Piutang", en: "Receivables" },
  "debts.dir.payable": { id: "Hutang", en: "Payables" },
  "debts.dirAria": { id: "Arah catatan", en: "Record direction" },
  "debts.countN": { id: "{n} catatan", en: "{n} records" },
  "debts.empty": { id: "Belum ada catatan aktif di sini.", en: "No active records here." },
  "debts.paidGroup": { id: "Riwayat lunas ({n})", en: "Settled history ({n})" },
  "debts.badgePaid": { id: "Lunas", en: "Paid" },
  "debts.badgeWrittenOff": { id: "Dihapus sbg rugi", en: "Written off" },
  "debts.ofPrincipal": { id: "dari {total}", en: "of {total}" },
  "debts.progressOf": { id: "Angsuran {a}/{b}", en: "Installment {a}/{b}" },
  "debts.progressLong": { id: "Cicilan {a} dari {b} kali terbayar", en: "{a} of {b} installments paid" },
  "debts.nextRun": { id: "Tempo berikutnya", en: "Next due" },
  "debts.remaining": { id: "Sisa", en: "Remaining" },
  "debts.principalLabel": { id: "Nominal awal", en: "Original amount" },
  "debts.party": { id: "Nama pihak", en: "Party name" },
  "debts.partyPh": { id: "Mis. Andi, Koperasi Kantor", en: "E.g. Andy, office co-op" },
  "debts.titlePh": { id: "Mis. Pinjaman motor (opsional)", en: "E.g. motor loan (optional)" },
  "debts.principalPh": { id: "Nominal saat dicatat", en: "Amount when recorded" },
  "debts.scheduleLabel": { id: "Jenis", en: "Type" },
  "debts.schedule.flex": { id: "Bebas", en: "Flexible" },
  "debts.schedule.installment": { id: "Cicilan", en: "Installments" },
  "debts.scheduleAria": { id: "Jenis pembayaran", en: "Payment schedule" },
  "debts.countNLabel": { id: "Jumlah kali bayar", en: "Number of payments" },
  "debts.perInstallment": { id: "≈ Rp {amount} / angsuran (terakhir menyesuaikan)", en: "≈ Rp {amount} per installment (last one adjusts)" },
  "debts.perInstallmentHint": { id: "Isi nominal & jumlah bayar dulu.", en: "Fill amount and count first." },
  "debts.firstDue": { id: "Tanggal tempo pertama", en: "First due date" },
  "debts.note": { id: "Catatan (opsional)", en: "Note (optional)" },
  "debts.notePh": { id: "Mis. tanpa bunga, tiap gajian", en: "E.g. no interest, each payday" },
  "debts.payAmount": { id: "Nominal pembayaran", en: "Payment amount" },
  "debts.payMax": { id: "maks", en: "max" },
  "debts.payBtn": { id: "Bayar", en: "Pay" },
  "debts.receiveBtn": { id: "Terima", en: "Receive" },
  "debts.payFull": { id: "Bayar sisa penuh", en: "Pay full remaining" },
  "debts.payInstallment": { id: "Bayar 1 cicilan", en: "Pay 1 installment" },
  "debts.markPaid": { id: "Tandai lunas (tanpa transaksi)", en: "Mark settled (no transaction)" },
  "debts.writeOff": { id: "Hapus sebagai rugi", en: "Write off as loss" },
  "debts.edit": { id: "Edit catatan", en: "Edit record" },
  "debts.delete": { id: "Hapus catatan", en: "Delete record" },
  "debts.confirmMarkPaid": { id: "Tandai lunas tanpa mencatat transaksi? Sisa langsung nol.", en: "Mark settled without a transaction? Remaining goes to zero." },
  "debts.confirmWriteOff": { id: "Hapus sebagai rugi? Piutangan dianggap tak tertagih dan keluar dari kekayaan bersih.", en: "Write off as loss? This receivable is treated as uncollectible and leaves net worth." },
  "debts.confirmDelete": { id: "Hapus catatan ini? Riwayat transaksinya tetap ada.", en: "Delete this record? Its transaction history stays." },
  "debts.residualNote": { id: "Sisa tanpa jadwal cicilan — bayar bebas atau tandai lunas.", en: "Remaining without a schedule — pay freely or mark settled." },
  "debts.errParty": { id: "Isi nama pihaknya dulu ya.", en: "Add the party name first." },
  "debts.errAmount": { id: "Nominal harus lebih dari nol.", en: "Amount must be greater than zero." },
  "debts.errCount": { id: "Jumlah cicilan 1–60 kali.", en: "Installments must be 1–60." },
  "debts.errDay": { id: "Pilih tanggal/hari temponya.", en: "Pick the due date/weekday." },
  "debts.toastSaved": { id: "Catatan hutang/piutang tersimpan ✓", en: "Debt record saved ✓" },
  "debts.toastDeleted": { id: "Catatan dihapus.", en: "Record deleted." },
  "debts.toastPaid": { id: "Lunas! 🎉", en: "Fully settled! 🎉" },
  "debts.toastPaidPart": { id: "Pembayaran tercatat ✓", en: "Payment recorded ✓" },
  "debts.toastMarkedPaid": { id: "Ditandai lunas.", en: "Marked as settled." },
  "debts.toastWrittenOff": { id: "Piutang dihapus sebagai rugi.", en: "Receivable written off." },
  "btn.saveDebt": { id: "Simpan catatan", en: "Save record" },
  "btn.saveDebtEdit": { id: "Simpan perubahan", en: "Save changes" },

  /* F9 — avatar & misi border */
  "prof.menu.avatar": { id: "Avatar & misi", en: "Avatar & missions" },
  "av.openAria": { id: "Buka avatar & misi", en: "Open avatar & missions" },
  "av.activeTier": { id: "Border aktif: {tier}", en: "Active border: {tier}" },
  "av.tier.none": { id: "—", en: "—" },
  "av.tier.bronze": { id: "Perunggu", en: "Bronze" },
  "av.tier.silver": { id: "Perak", en: "Silver" },
  "av.tier.gold": { id: "Emas", en: "Gold" },
  "av.tier.platinum": { id: "Platinum", en: "Platinum" },
  "av.pickKicker": { id: "PILIH AVATAR", en: "PICK YOUR AVATAR" },
  "av.shuffle": { id: "Acak lagi", en: "Shuffle" },
  "av.pickAria": { id: "Pilihan avatar", en: "Avatar choices" },
  "av.pickHint": { id: "Tap salah satu buat dipakai — bisa diganti kapan saja.", en: "Tap one to use it — you can change anytime." },
  "av.toastSaved": { id: "Avatar diperbarui ✓", en: "Avatar updated ✓" },
  "av.missionTitle": { id: "MISI BORDER", en: "BORDER MISSIONS" },
  "av.m.bronze.title": { id: "Perunggu · Lengkapi profil", en: "Bronze · Complete profile" },
  "av.m.bronze.desc": { id: "Pilih avatar pertamamu & ganti username minimal sekali.", en: "Pick your first avatar & change your username once." },
  "av.m.silver.title": { id: "Perak · Konsisten 7 hari", en: "Silver · 7-day streak" },
  "av.m.silver.desc": { id: "Catat transaksi 7 hari berturut-turut.", en: "Log transactions 7 days in a row." },
  "av.m.gold.title": { id: "Emas · Level 5 tercapai", en: "Gold · Reach level 5" },
  "av.m.gold.desc": { id: "Kumpulkan XP sampai Level 5.", en: "Collect XP until you hit level 5." },
  "av.m.platinum.title": { id: "Platinum · Jelajahi semua fitur", en: "Platinum · Explore everything" },
  "av.m.platinum.desc": { id: "Coba simulasi nabung, bikin goal, catat hutang/piutang, dan ganti tema.", en: "Try the savings simulator, set a goal, track a debt, and switch theme." },
  "av.check.simulate": { id: "Simulasi nabung", en: "Savings simulator" },
  "av.check.goal": { id: "Bikin goal", en: "Set a goal" },
  "av.check.debts": { id: "Catat hutang/piutang", en: "Track a debt" },
  "av.check.theme": { id: "Ganti tema", en: "Switch theme" },
  "av.toast.bronze": { id: "Border Perunggu terbuka! 🥉", en: "Bronze border unlocked! 🥉" },
  "av.toast.silver": { id: "Border Perak terbuka! 🥈", en: "Silver border unlocked! 🥈" },
  "av.toast.gold": { id: "Border Emas terbuka! 🥇", en: "Gold border unlocked! 🥇" },
  "av.toast.platinum": { id: "Border Platinum terbuka! 💎", en: "Platinum border unlocked! 💎" },
  "cel.kicker": { id: "KABAR BAGUS!", en: "GREAT NEWS!" },
  "cel.cta": { id: "Keren, tutup", en: "Nice, close" },
  "av.savedTitle": { id: "Avatar barumu pas banget! ✨", en: "Your new avatar fits perfectly! ✨" },
  "ch.doneTitle": { id: "Tantangan selesai!", en: "Challenge complete!" },
  "goal.claimTitle": { id: "Target tercapai! 🏆", en: "Goal reached! 🏆" },
  "goal.claimDesc": { id: "“{name}” resmi masuk daftar pencapaianmu. Wujudkan target berikutnya!", en: "“{name}” is now officially in your achievements list. Time for the next one!" },
